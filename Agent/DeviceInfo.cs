...
public class DeviceInfo
{
    ...
    // Hidden helpers (CreateNoWindow): used once at startup for inventory only.
    ...
    {
        var encoded = Convert.ToBase64String(System.Text.Encoding.Unicode.GetBytes(expression));
        try
        {
            var psi = new System.Diagnostics.ProcessStartInfo
            {
